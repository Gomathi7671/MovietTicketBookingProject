...
public class BookingController {
    ...
    public String selectSeats(@RequestParam Long showtimeId, HttpSession session, Model model) {
        ...
        if (email == null) {
            throw new UserNotLoggedInException("❌ Please login to continue booking!");
        }
    ...
    public String confirmBooking(@RequestParam Long showtimeId,
        ...
        if (seatIds == null || seatIds.isEmpty()) {
            throw new NoSeatsSelectedException("⚠️ You must select at least one seat!");
        }
        ...
        for (String seatNumber : seatIds) {
            ...
            try {
                ...
                throw new BookingFailureException("❌ Booking failed for seat " + seatNumber + ": " + e.getMessage());
            }
        }
